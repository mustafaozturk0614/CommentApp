...
//   createLikes();
    ...
    public  void createproduct(){
        ...
        Product product1=Product.builder().name("S�ta� Ayran").expirationDate(LocalDate.now().plusDays(7)).price(15).build();
        Product product2=Product.builder().name("P�nar S�t").expirationDate(LocalDate.now().minusDays(10)).price(20).build();
        Product product3=Product.builder().name("P�nar Salam").expirationDate(LocalDate.now().plusDays(30)).price(25).build();
        Product product4=Product.builder().name("Cappy Meyve Suyu").expirationDate(LocalDate.now().minusDays(10)).price(15).build();
        Product product5=Product.builder().name("Conon Ya�zc�").price(700).build();
    ...
    public  void createproductComment(){
        ...
        ProductComment pc2=ProductComment.builder().comment("�ok g�zel bir bilgisayar").productId(1L).userId(2L).commentDate(LocalDate.now().minusMonths(10)).build();
        ProductComment pc3=ProductComment.builder().comment("fazla be�enmedim idare eder").productId(1L).userId(3L).commentDate(LocalDate.now().minusMonths(1)).build();
        ProductComment pc4=ProductComment.builder().comment("be�endim").productId(8L).userId(4L).commentDate(LocalDate.now().minusDays(3)).build();
        ...
        ProductComment pc8=ProductComment.builder().comment("k�t� bir �r�n").productId(6L).userId(4L).commentDate(LocalDate.now().minusDays(3)).build();
        ProductComment pc9=ProductComment.builder().comment("�ok g�zel").productId(7L).userId(2L).commentDate(LocalDate.now().minusDays(266)).build();
        ProductComment pc10=ProductComment.builder().comment("be�endim").productId(8L).userId(3L).commentDate(LocalDate.now().minusYears(1)).build();
